...
$tipoCredito = 'MUJEREMPRENDEDORA';
$productos = $fn_credito->fncredito_xget_producto($id);
print_r($productos);
/*
300,00 a 1.060,00 dólares	3 meses	12 meses
1061,00 a 2.100,00 dolares	3 meses	24 meses
2.101,00 a 3.150,00 dólares	3 meses	36 meses
*/
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="about-boxarea">
                                    ...
                                    <div class="text">
                                        ...
                                        <p style="font-size: 18px;">hasta 
                                            <span style="font-size: 25px;font-weight: 800; color: #a31a16;"> 3.000,00 </span>dólares</p>
                                    </div>
                                </div>
                            </div>
                            <div class="space16"></div>
                            ...
                            <div data-aos="fade-left" data-aos-duration="1000" style="border-bottom: 4px solid #a31a16">
                                <div class="about-boxarea">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="space16"></div>
                                        <p style="font-size: 18px;">Ser mayor de 18 años y no mayor a 55 años incluido la vida del crédito.<br><br> </p>
                            ...
                            <div data-aos="fade-left" data-aos-duration="1100" style="border-bottom: 4px solid #a31a16">
                                <div class="about-boxarea">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="space16"></div>
                                        <p style="font-size: 18px;">máximo hasta <span style="font-size: 25px;font-weight: 800; color: #a31a16;">36 </span>meses                            </p>
                                    </div>
                                </div>
                            </div>
                            <div class="space16"></div>
                            ...
                            <div data-aos="fade-left" data-aos-duration="1100" style="border-bottom: 4px solid #a31a16">
                                <div class="about-boxarea">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="space16"></div>
                                        <p style="font-size: 18px;">Mujeres que la permanencia de su negocio sea al menos de un año en el mercado, ó mujeres con 6 meses de estabilidad laboral.                                                                              </p>
                                    </div>
                                </div>
                            </div>
                        </div>
