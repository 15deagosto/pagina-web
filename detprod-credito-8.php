...
10.501,00 a 25.000,00 dólares	3 meses	54 meses
21.001,00 a 40.000,00 dólares	3 meses	66 meses
                                ...
                                <div class="about-boxarea">
                                    ...
                                    <div class="text">
                                        ...
                                        <p style="font-size: 18px;">hasta 
                                            <span style="font-size: 25px;font-weight: 800; color: #a31a16;"> 40.000,00 </span>dólares</p>
                                    </div>
                                </div>
                            </div>
                            <div class="space16"></div>
                            ...
                            <div data-aos="fade-left" data-aos-duration="1100" style="border-bottom: 4px solid #a31a16">
                                <div class="about-boxarea">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="space16"></div>
                                        <p style="font-size: 18px;">máximo hasta <span style="font-size: 25px;font-weight: 800; color: #a31a16;">66 </span>meses                            </p>
                                    </div>
                                </div>
                            </div>
                            <div class="space16"></div>
                            ...
                            <div data-aos="fade-left" data-aos-duration="1100" style="border-bottom: 4px solid #a31a16">
                                <div class="about-boxarea">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="space16"></div>
                                        <p style="font-size: 18px;">Destinado para socios externos o nuevos  en categoria Doble AA, triple AAA.                                   </p>
                                    </div>
                                </div>
                            </div>
                        </div>
