...
if ($iopc == 1) {
    ...
    $numtarea = $a->fn104_uquejas_estado($id, $st);
    if ($st == 0) {
        ?>
        <label><input type="checkbox" value="1" onchange="cn104_001_2(1, this.value,<?php echo $id ?>)"> PENDIENTE</label> 
        <?php
    } else {
        ?>
        <label><input checked="" type="checkbox" value="0" onchange="cn104_001_2(1, this.value,<?php echo $id ?>)"> ATENDIDO</label> 
        <?php
    }
}
if ($iopc == 2) {
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                          <button onclick="md104_001_d2(1,<?php echo $id ?>)" data-toggle="modal" data-target="#modalcontent_lg" class="btn btn-warning shadow btn-xs sharp mr-1"><i class="fa fa-eye"></i></button>  
                        </div>												
                    </td>												
                </tr>
            <?php
