...
if ($opc_cn == 1) {
    ...
    $tipo_prod = 0;
    $estado = 0;
    $cuenta = $fn23->fn23_cinversionseps_xdata($montoin_inversion, $montoout_inversion, $diain_inversion, $diaout_inversion,$prociento_inversion);
...
if ($opc_cn == 2) {
    ...
    $diaout_inversion = ($_POST['diaout_inversion']);
    $prociento_inversion = ($_POST['prociento_inversion']);
    $cuenta = $fn23->fn23_uinversionseps_x($montoin_inversion, $montoout_inversion, $diain_inversion, $diaout_inversion,$prociento_inversion, $id);
