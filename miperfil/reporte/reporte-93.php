...
$objPHPExcel->getActiveSheet()->setCellValue('F1', 'CAPITAL');
...
$objPHPExcel->getActiveSheet()->setCellValue('J1', 'HORA');
$objPHPExcel->getActiveSheet()->getColumnDimension('K')->setAutoSize(true);
$objPHPExcel->getActiveSheet()->setCellValue('K1', 'ESTADO');
$objPHPExcel->getActiveSheet()->getColumnDimension('L')->setAutoSize(true);
$objPHPExcel->getActiveSheet()->setCellValue('L1', 'ACUERDO');
$count = 5;
$letra = 'F';
//body excel
...
while ($detalletabla = $pedidos->fetch_assoc()) {
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('C' . $fila, $detalletabla['ciudad_inversion']);
    $objPHPExcel->getActiveSheet()->setCellValue('D' . $fila, $detalletabla['telefono_inversion']);
    $objPHPExcel->getActiveSheet()->setCellValue('E' . $fila, $detalletabla['entidad_inversion']);
    $objPHPExcel->getActiveSheet()->setCellValue('F' . $fila, $detalletabla['monto_inversion']);
    $objPHPExcel->getActiveSheet()->setCellValue('G' . $fila, $detalletabla['nombre_prod']);
    $objPHPExcel->getActiveSheet()->setCellValue('H' . $fila, $detalletabla['email_inversion']);
    $objPHPExcel->getActiveSheet()->setCellValue('I' . $fila, $detalletabla['fecha_inversion']);
    $objPHPExcel->getActiveSheet()->setCellValue('J' . $fila, $detalletabla['hora_inversion']);
    $objPHPExcel->getActiveSheet()->setCellValue('K' . $fila, $estado);
    $objPHPExcel->getActiveSheet()->setCellValue('L' . $fila, $acuerdo);
//    
//
