...
if ($opc_mod == 1) {
    ...
    <div class="modal-footer">
        ...
        <button type="button"  onclick="cn12_f1()" data-dismiss="modal" class="btn btn-warning" >Guardar </button>
    </div>
    <?php
}
...
if ($opc_mod == 2) {
                    ...
                    <div class="basic-form">
                        <form class="form-valide" id="frm_editar" method="post">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Nombre</label>
                                <div class="col-sm-12">
                                    <input type="text" name="nombre_rol" class="form-control" value="<?php echo ($tupla[0]['nombre_rol']) ?>">
                                </div>
                            </div>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-danger light" data-dismiss="modal">Cerrar</button>
        <button onclick="cn12_f2()" type="button" class="btn btn-warning" data-dismiss="modal">Guardar cambios</button>
    </div>
    <?php
}
    ...
    <div class="modal-content" id="content_sm">
        ...
        <div class="modal-body">
            <form action="" method="POST" id="frm_delete">
                ...
                <button type="button" onclick="cn12_f5(5, <?php echo $id ?>, -1)"  class="btn btn-primary" data-dismiss="modal">SI</button>
            </form>
        </div>
