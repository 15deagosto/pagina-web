...
if ($opc_mod == 1) {
    ...
    <div class="modal-footer">
        ...
        <button type="button"  onclick="cn11_f1()" data-dismiss="modal" class="btn btn-warning" >Guardar </button>
    </div>
    <?php
}
...
if ($opc_mod == 2) {
                    ...
                    <div class="basic-form">
                        <form class="form-valide" id="frm_editar" method="post">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Nombre</label>
                                <div class="col-sm-12">
                                    <input type="text" name="nombre_usuario" class="form-control" value="<?php echo ($tupla[0]['nombre_usuario']) ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Apellido</label>
                                <div class="col-sm-12">
                                    <input type="text" name="apellido_usuario" class="form-control" value="<?php echo ($tupla[0]['apellido_usuario']) ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Teléfono</label>
                                <div class="col-sm-12">
                                    <input type="text" name="telefono_usuario" class="form-control" value="<?php echo ($tupla[0]['telefono_usuario']) ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Email</label>
                                <div class="col-sm-12">
                                    <input type="text" name="email_usuario" class="form-control" value="<?php echo ($tupla[0]['email_usuario']) ?>">
                                </div>
                            </div>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-danger light" data-dismiss="modal">Cerrar</button>
        <button onclick="cn11_f2()" type="button" class="btn btn-warning" data-dismiss="modal">Guardar cambios</button>
    </div>
    <?php
}
    ...
    <div class="modal-content" id="content_sm">
        ...
        <div class="modal-body">
            <form action="" method="POST" id="frm_delete">
                ...
                <button type="button" onclick="cn11_f7(7, <?php echo $id ?>, -1)"  class="btn btn-primary" data-dismiss="modal">SI</button>
            </form>
        </div>
    ...
    <div class="modal-content" id="content_sm">
        ...
        <div class="modal-body">
            <form action="" method="POST" id="frm_password">
                ...
                <input type="hidden" name="dato_1" value="<?php echo $id ?>">
                <input type="hidden" name="dato_2" value="<?php echo $mail ?>">
                ...
                <center>
                    <button onclick="cn11_f5()" type="button" class="btn btn-warning">Actualizar contraseña</button>
                </center>
            </form>
        </div>
