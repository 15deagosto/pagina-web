...
if ($opc_mod == 1) {
    ...
    <div class="modal-footer">
        ...
        <button type="button"  onclick="cn56_f1()" data-dismiss="modal" class="btn btn-warning" >Guardar </button>
    </div>
    <?php
}
...
if ($opc_mod == 2) {
    $id = $_POST['dato_1'];
    $tupla = $fn56->fn56_rnoticias_x($id);
    ?>
    <div class="modal-header">
                    ...
                    <div class="basic-form">
                        <form class="form-valide" id="frm_editar" >
                            ...
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Título</label>
                                <div class="col-sm-12">
                                    <input type="text" name="titulo" class="form-control" value="<?php echo $tupla[0]['titulo_noticia'] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Fecha</label>
                                <div class="col-sm-12">
                                    <input type="date" name="fechainicio_noticia" class="form-control" value="<?php echo $tupla[0]['fechainicio_noticia'] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Resumen</label>
                                <div class="col-sm-12">
                                    <textarea name="resumen" class="form-control"><?php echo $tupla[0]['resumen_noticia'] ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Descripción</label>
                                <div class="col-sm-12">
                                    <textarea name="descripcion" id="descripcion" class="form-control"><?php echo $tupla[0]['detalle_noticia'] ?></textarea>
                                </div>
                            </div>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-danger light" data-dismiss="modal">Cerrar</button>
        <button onclick="cn56_f2()" type="button" class="btn btn-warning" data-dismiss="modal">Guardar cambios</button>
    </div>
    <?php
}
        ...
        <script>
            $(document).ready(function () {
                $("#kv-explorer").fileinput({
                    ...
                    initialPreview: [
                        "https://supaysoft.com/proyectos/15agosto/V3/assets/img/<?php echo ($tupla[0]['img_noticia']) ?>"
                    ],
    ...
    <div class="modal-content" id="content_sm">
        ...
        <div class="modal-body">
            <form action="" method="POST" id="frm_delete">
                ...
                <button type="button" onclick="cn56_f7(7, <?php echo $id ?>, -1)"  class="btn btn-primary" data-dismiss="modal">SI</button>
            </form>
        </div>
...
if ($opc_mod == 6) {
    ...
    $tupla = $fn56->fn56_rnoticias_x($id_noticia);
    ?>
    <!-- Material color picker -->
    <script src="vendor/moment/moment.min.js"></script>
    <script src="vendor/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js"></script>
                ...
                <div class="col-md-12">
                    <div class="basic-form">
                        <form class="form-valide" id="frm_nuevo" method="post">
                            ...
                            <input type="hidden" value="<?php echo $tupla[0]['img_noticia'] ?>" name="img_ant">
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Tamaño máxino de imagenes  25mb</label>
                                <label class="col-sm-12 col-form-label">Dimesiones de la imagen 1920px de alto x 1080px de ancho</label>
                            </div>
                            <div class="form-group row offset-3" id="result_img">
                                <?php if ($qImg == 1) { ?>
                                    <img src="../assets/img/<?php echo $tupla[0]['img_noticia'] ?>" width="200px" />
                                <?php } ?> 
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-danger light" data-dismiss="modal">Cerrar</button>
        <button type="button"  onclick="cn56_f6(<?php echo $qImg ?>,<?php echo $id_noticia ?>,<?php echo $id ?>)"  class="btn btn-warning" >Guardar </button>
    </div>
    <?php
}
if ($opc_mod == 7) {
                    ...
                    <div class="basic-form">
                        <form class="form-valide" id="frm_nuevoimgdetalle" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-sm-12 col-form-label">Dimesiones de la imagen 1920 de alto x 1700 de ancho</label>
                            </div>
                            <div class="form-group row offset-3" id="result_img">
                                <?php if ($qImg == 1) { ?>
                                    <img src="../assets/img/<?php echo $tupla[0]['img2_noticia'] ?>" width="200px" />
                                <?php } ?> 
                                <div id="cargando_img" class="bg_load" style="display: none" >
                                    <img class="loader_animation" src="../images/loading-gif.gif"  /><br>
                                </div>
                            ...
                            <button type="button"  onclick="cn56_f9(<?php echo $qImg ?>,<?php echo $id_noticia ?>,<?php echo $id ?>)"  class="btn btn-danger" > <i class="fa fa-times"></i> Eliminar imágen </button>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-danger light" data-dismiss="modal">Cerrar</button>
        <button type="button"  onclick="cn56_f8(<?php echo $qImg ?>,<?php echo $id_noticia ?>,<?php echo $id ?>)"  class="btn btn-warning" >Guardar </button>
    </div>
    <?php
}