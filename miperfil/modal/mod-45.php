...
if ($opc_mod == 1) {
    $id = $_POST['dato_1'];
    $tupla = $fn45->fn45_rsolinversion_x($id);
    ?>
                    ...
                    <div class="basic-form">
                        <form class="form-valide" id="frm_nuevo" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <p><?php echo ($tupla[0]['nombre_inversion'].' '.$tupla[0]['apellido_inversion']) ?></p>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Teléfono</label>
                                <div class="col-sm-8">
                                    <p><?php echo ($tupla[0]['telefono_inversion']) ?></p>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Email</label>
                                <div class="col-sm-8">
                                    <p><?php echo ($tupla[0]['email_inversion']) ?></p>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Entidad</label>
                                <div class="col-sm-8">
                                    <p><?php echo ($tupla[0]['entidad_inversion']) ?></p>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Cuidad</label>
                                <div class="col-sm-8">
                                    <p><?php echo ($tupla[0]['ciudad_inversion']) ?></p>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <p><?php echo ($tupla[0]['monto_inversion']) ?></p>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <p><?php echo ($tupla[0]['fecha_inversion']) ?></p>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Hora</label>
                                <div class="col-sm-8">
                                    <p><?php echo ($tupla[0]['hora_inversion']) ?></p>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Acuerdo</label>
                                <div class="col-sm-8">
                                    <?php if(($tupla[0]['acuerdo_inversion'])== 1 ){ ?>
...
if ($opc_mod == 2) {
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-danger light" data-dismiss="modal">Cerrar</button>
        <button type="button"  onclick="cn45_d2()" data-dismiss="modal" class="btn btn-warning" >Aplicar </button>
    </div>
    <?php
