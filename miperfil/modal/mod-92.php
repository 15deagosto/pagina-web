...
if ($opc_mod == 1) {
    ...
    <div class="modal-footer">
        ...
        <button type="button"  onclick="cn92_f1()" data-dismiss="modal" class="btn btn-warning" >Guardar </button>
    </div>
    <?php
}
...
if ($opc_mod == 2) {
    ...
    $id_aviso = $_POST['dato_1'];
    $tupla = $fn92->fn92_ravisos_xid($id_aviso);
    ?>
    <div class="modal-header">
        <h5 class="modal-title">Editar "<?php echo ($tupla[0]['img_avisos']) ?>"</h5>
        <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
        </button>
    </div>
    <div class="modal-body">
                ...
                <div class="col-md-12">
                    <div class="basic-form">
                        <form class="form-valide" id="frm_editar" >
                            ...
                            <input type="hidden" name="dato_1" value="<?php echo $id_aviso ?>">

                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Fecha Inicio</label>
                                <div class="col-sm-12">
                                    <input type="date" name="fecini_avisos" class="form-control" value="<?php echo $tupla[0]['fecini_avisos'] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Fecha Final</label>
                                <div class="col-sm-12">
                                    <input type="date" name="fecfin_avisos" class="form-control" value="<?php echo $tupla[0]['fecfin_avisos'] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">URL (Si este campo esta vacío, la imagen no ejecutará el evento)</label>
                                <div class="col-sm-12">
                                    <input type="text" name="url_avisos" class="form-control" value="<?php echo $tupla[0]['url_avisos'] ?>">
                                </div>
                            </div>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-danger light" data-dismiss="modal">Cerrar</button>
        <button onclick="cn92_f2()" type="button" class="btn btn-warning" data-dismiss="modal">Guardar cambios</button>
    </div>
    <?php
}
...
if ($opc_mod == 3) {
    $id = $_POST['dato_1'];
    $tupla = $fn92->fn92_rnoticias_x($id);
    ?>
    <div class="modal-header">
        ...
        <script>
            $(document).ready(function () {
                $("#kv-explorer").fileinput({
                    ...
                    initialPreview: [
                        "http://supaysoft.sytes.net:84/proyectos/cacec/cacecV2/images/<?php echo ($tupla[0]['img_noticia']) ?>"
                    ],
    ...
    <div class="modal-content" id="content_sm">
        ...
        <div class="modal-body">
            <form action="" method="POST" id="frm_delete">
                ...
                <button type="button" onclick="cn92_f7(7, <?php echo $id ?>, -1)"  class="btn btn-primary" data-dismiss="modal">SI</button>
            </form>
        </div>
...
if ($opc_mod == 6) {
                ...
                <div class="col-md-12">
                    <div class="basic-form">
                        <form class="form-valide" id="frm_nuevo" method="post">
                            ...
                            <input type="hidden" value="<?php echo $tupla[0]['img_avisos'] ?>" name="img_ant">
                            <div class="form-group row">
                            ...
                            <div class="form-group row offset-3" id="result_img">
                                <img src="../images/<?php echo $tupla[0]['img_avisos'] ?>" width="200px" />
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-danger light" data-dismiss="modal">Cerrar</button>
        <button type="button"  onclick="cn92_f6(<?php echo $qImg ?>,<?php echo $id_aviso ?>,<?php echo $id ?>)"  class="btn btn-warning" >Guardar </button>
    </div>
    <?php
}
if ($opc_mod == 7) {
    ...
    $tupla = $fn92->fn92_rnoticias_x($id_noticia);
    ?>
    <!-- Material color picker -->
    <script src="vendor/moment/moment.min.js"></script>
    <script src="vendor/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js"></script>
                ...
                <div class="col-md-12">
                    <div class="basic-form">
                        <form class="form-valide" id="frm_nuevoimgdetalle" method="post">
                            ...
                            <button type="button"  onclick="cn92_f9(<?php echo $qImg ?>,<?php echo $id_noticia ?>,<?php echo $id ?>)"  class="btn btn-danger" > <i class="fa fa-times"></i> Eliminar imágen </button>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-danger light" data-dismiss="modal">Cerrar</button>
        <button type="button"  onclick="cn92_f8(<?php echo $qImg ?>,<?php echo $id_noticia ?>,<?php echo $id ?>)"  class="btn btn-warning" >Guardar </button>
    </div>
    <?php
}