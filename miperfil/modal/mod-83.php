...
if ($opc_mod == 1) {
    ...
    <div class="modal-header">
        <h5 class="modal-title">Nueva Transparencia</h5>
                    ...
                    <div class="basic-form">
                        <form class="form-valide" id="frm_nuevo" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" name="nombre_transp" class="form-control" placeholder="">
                                </div>
                            </div>
    ...
    <div class="modal-footer">
        ...
        <button type="button"  onclick="cn83_f1()" data-dismiss="modal" class="btn btn-warning" >Guardar </button>
    </div>
    <?php
}
...
if ($opc_mod == 2) {
                    ...
                    <div class="basic-form">
                        <form class="form-valide" id="frm_editar" >
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Nombre</label>
                                <div class="col-sm-8">
                                    <input type="date" name="nombre_transp" class="form-control" value="<?php echo ($tupla[0]['nombre_transp']) ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">ICONO</label>
                                <div class="col-sm-8">
                                    <select class="form-control" name="icon_transp">
                                        <option value="<?php echo ($tupla[0]['icon_transp']) ?>">
                                        <?php echo ($tupla[0]['icon_transp']) ?>
                                        </option>
                                        <option value="fa-bar-chart-o">fa-bar-chart-o</option>
                                        <option value="fa-file-excel-o">fa-file-excel-o</option>
                                    </select>
                                    <input type="date" name="nombre_transp" class="form-control" value="">
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-danger light" data-dismiss="modal">Cerrar</button>
        <button onclick="cn83_f2()" type="button" class="btn btn-warning" data-dismiss="modal">Guardar cambios</button>
    </div>
    <?php
}
    ...
    <div class="modal-content" id="content_sm">
        ...
        <div class="modal-body">
            <form action="" method="POST" id="frm_delete">
                ...
                <button type="button" onclick="cn83_f4(4, <?php echo $id ?>, -1)"  class="btn btn-primary" data-dismiss="modal">SI</button>
            </form>
        </div>
