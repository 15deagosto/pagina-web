...
if ($opc_mod == 1) {
    $id = $_POST['dato_1'];
    $tupla = $fn104->fn54_rquejas_x($id);
    $quejaname=$fn104->fn104_tipo_quejas($tupla[0]['tipo_queja']);
    ?>
...
if ($opc_mod == 2) {
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <select  name="agencia" class="form-control">
                                        ...
                                        <?php
                                        $tabla = $fn104->fn104_rnosotros_all();
                                        if ($tabla->num_rows > 0) {
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-danger light" data-dismiss="modal">Cerrar</button>
        <button type="button"  onclick="cn104_r002_f1()" data-dismiss="modal" class="btn btn-warning" >Aplicar </button>
    </div>
    <?php
