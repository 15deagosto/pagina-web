...
if ($opc_mod == 1) {
    $id = $_POST['dato_1'];
    $tupla = $fn93->fn93_rsolinversion_x($id);
    ?>
...
if ($opc_mod == 2) {
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-danger light" data-dismiss="modal">Cerrar</button>
        <button type="button"  onclick="cn93_d2()" data-dismiss="modal" class="btn btn-warning" >Aplicar </button>
    </div>
    <?php
