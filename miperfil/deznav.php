<div class="deznav-scroll">
    <ul class="nav menu-tabs">
        <?php
        $arregloitems = $m->fn_rmenu_xrol($idroll_open);
        $padre_id = $m->fn_rpadre_xid($opc);
        for ($i = 0; $i < count($arregloitems); $i++) {
             $act = ''; 
            if($padre_id == $arregloitems[$i]['id_menu']){
              $act = 'active';  
            }
            ?>
            <li class="nav-item">
                <!--active-->
                <a title="<?php echo utf8_encode(strtoupper($arregloitems[$i]['nombre_menu'])) ?>" class="nav-link <?php echo $act ?>" data-toggle="tab" href="#menu-<?php echo utf8_encode($arregloitems[$i]['id_menu']) ?>">
                    <i class="nav-icon <?php echo utf8_encode($arregloitems[$i]['icon_menu']) ?>"></i>
                </a>
            </li>
            <?php
        }
        ?>
<!--        <li class="nav-item">
            <a class="nav-link " data-toggle="tab" href="#menu-2">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#menu-3">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#menu-4">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#menu-5">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#menu-6">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#menu-7">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#menu-8">
                <svg id="icon-pages" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
            </a>
        </li>-->
