...
?>
<script src="./jsopc/jsopc-21.js"></script>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Tasas de interés </h4>
                    <div class="btn-group mb-2">
                        <a href="index.php?opc=21"  class="btn btn-warning light  px-3" >
                            <i class="fa fa-refresh"></i> <b class="caret m-l-5"></b>
                        </a>
                        <button onclick="md21_d1(1)" type="button" data-toggle="modal" data-target="#modalcontent_md" class="btn btn-primary light  px-3" data-toggle="dropdown">
                            <i class="fa fa-plus"></i> <b class="caret m-l-5"></b>
                        </button>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive" id="table21">
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <select class="form-control" onchange="cn21_f7(8,<?php echo $id ?>, this.value)">
                                                ...
                                                <option  value="<?php echo $menu2['id_frecpago'] ?>" <?php if( $menu2['id_frecpago'] == $menu['id_frecuencia']){echo("selected");}?>><?php echo ($menu2['nombre_frecpago']) ?></option>
                                                <?php } ?>
                                            </select> 
                                        ...
                                        <td>
                                            ...
                                            <div class="custom-control custom-checkbox mb-3">
                                                ...
                                                if($st == 0){
                                                ?>
                                                <input value="1" name="estado" onchange="cn21_f4(4, <?php echo $id ?>, this.value)" type="checkbox" class="custom-control-input" id="customCheckBox<?php echo $id ?>" required>
                                                <label class="custom-control-label" for="customCheckBox<?php echo $id ?>">Inactivo</label>
                                                <?php
                                                }else if($st == 1){
                                                ?>
                                                <input value="0" name="estado" onchange="cn21_f4(4, <?php echo $id ?>, this.value)" checked type="checkbox" class="custom-control-input" id="customCheckBox<?php echo $id ?>" required>
