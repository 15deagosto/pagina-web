...
$a = new Fn_45();
$tabla = $a->fn45_rsolinversion_all();
$hasta = date('Y-m-d');
$desde = date('Y-m-d', strtotime($hasta . "- 30 days"));
?>
<script src="./jsopc/jsopc-45.js"></script>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Solicitudes de Inversión </h4>
                    ...
                    <div class="btn-group mb-2">
                        <a href="index.php?opc=45"  class="btn btn-warning light  px-3" >
                            <i class="fa fa-refresh"></i> <b class="caret m-l-5"></b>
                        </a>
                        <button onclick="md45_002_d1(2)" type="button" data-toggle="modal" data-target="#modalcontent_md" class="btn btn-primary light  px-3" data-toggle="dropdown">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive" id="table45">
                        ...
                        <table id="example3" class="display">
                            ...
                            <tbody>
                                ...
                                while ($menu = $tabla->fetch_assoc()) {
                                    ...
                                    $detzona =  $a->fn45_rzona_xid($menu['ciudad_inversion']);
                                ?>
                                    <tr>
