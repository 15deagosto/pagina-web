...
$a = new Fn_44();
$tabla = $a->fn44_rsolcredito_all();
$hasta = date('Y-m-d');
$desde = date('Y-m-d', strtotime($hasta . "- 30 days"));
?>
<script src="./jsopc/jsopc-44.js"></script>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Solicitudes de Crédito </h4>
                    ...
                    <div class="btn-group mb-2">
                        <a href="index.php?opc=44"  class="btn btn-warning light  px-3" >
                            <i class="fa fa-refresh"></i> <b class="caret m-l-5"></b>
                        </a>
                         <button onclick="md44_002_d1(2)" type="button" data-toggle="modal" data-target="#modalcontent_md" class="btn btn-primary light  px-3" data-toggle="dropdown">
                            <i class="fa fa-filter"></i> <b class="caret m-l-5"></b>
                        </button>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive" id="table44">
                        ...
                        <table id="example3" class="display">
                            ...
                            <tbody>
                                ...
                                while ($menu = $tabla->fetch_assoc()) {
                                    ...
                                    $id = $menu['id_credito'];
                                    $detzona =  $a->fn44_rzona_xid($menu['ciudad_credito']);
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <button onclick="md44_d1(1,<?php echo $id ?>)" data-toggle="modal" data-target="#modalcontent_md" class="btn btn-warning shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                <?php
