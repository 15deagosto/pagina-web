...
$tabla = $a->get_visitas();
?>
<script src="./jsopc/jsopc-48.js"></script>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="btn-group mb-2">
                        ...
                        <a href="index.php?opc=48"  class="btn btn-warning light  px-3" >
                            <i class="fa fa-refresh"></i> <b class="caret m-l-5"></b>
                        </a>
                        <button onclick="md48_001_d1(1)" type="button" data-toggle="modal" data-target="#modalcontent_md" class="btn btn-primary light  px-3" data-toggle="dropdown">
                            <i class="fa fa-filter"></i> <b class="caret m-l-5"></b>
                        </button>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive" id="table48">
                    ...
                    <div id="div_grafico1" style="width: 50% !important ; display: block; box-sizing: border-box;">
                        ...
                        if ($tabla->num_rows > 0) {
                            ...
                            $arraynum = '';
                            while ($data = $tabla->fetch_assoc()) {
                                $arrayname.="'".trim(($data['lugar_pagina']))."',";
                                $arraynum.="".$data['vp'].",";
                            }
                            ...
                            var myChart = new Chart(ctx, {
                                ...
                                options: {
                                    ...
                                    plugins: {
                                      ...
                                      title: {
                                        display: true,
                                        text: '<?php echo $masvisitado ?> Lugares donde más nos visitan'
                                      }
                                    }
