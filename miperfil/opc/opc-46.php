...
$tabla = $a->get_visitas();
?>
<script src="./jsopc/jsopc-46.js"></script>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="btn-group mb-2">
                        <a href="index.php?opc=46"  class="btn btn-warning light  px-3" >
                            <i class="fa fa-refresh"></i> <b class="caret m-l-5"></b>
                        </a>
                        <button onclick="md46_001_d1(1)" type="button" data-toggle="modal" data-target="#modalcontent_md" class="btn btn-primary light  px-3" data-toggle="dropdown">
                            <i class="fa fa-filter"></i> <b class="caret m-l-5"></b>
                        </button>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive" id="table46">
