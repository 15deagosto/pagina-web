...
class Fn46 {
    ...
    function get_visitas() {
        ...
        $sql2 = "select id_pagina,nombre_pagina,url_pagina,COUNT(id_pagina) as vp ,ip_pagina,"
                ...
                . "WHERE tipo_pagina=2 GROUP by nombre_pagina ORDER by vp  DESC LIMIT 0,20";
        //echo $sql2;
        $arreglo;
    ...
    function get_visitas_limit($limit) {
        ...
        $sql2 = "select id_pagina,nombre_pagina,url_pagina,COUNT(id_pagina) as vp ,ip_pagina,"
                . "browser_pagina,sistema_pagina,final_pagina,hora_pagina,tipo_pagina from paginas "
                . "WHERE tipo_pagina=2 GROUP by nombre_pagina ORDER by vp  DESC LIMIT 0,$limit";
        //echo $sql2;
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Lo sentimos, No existe visitas.";
    ...
    function get_navegavisitas() {
        ...
        $sql2 = "select id_pagina,nombre_pagina,url_pagina,COUNT(id_pagina) as vp ,ip_pagina,"
                . "browser_pagina,sistema_pagina,final_pagina,hora_pagina,tipo_pagina from paginas "
                . "WHERE tipo_pagina=2 GROUP by browser_pagina ORDER by vp  DESC LIMIT 0,20";
        //echo $sql2;
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Lo sentimos, No existe visitas.";
    ...
    function get_sovisitas() {
        ...
        $sql2 = "select id_pagina,nombre_pagina,url_pagina,COUNT(id_pagina) as vp ,ip_pagina,"
                . "browser_pagina,sistema_pagina,final_pagina,hora_pagina,tipo_pagina from paginas "
                . "WHERE tipo_pagina=2 GROUP by sistema_pagina ORDER by vp  DESC LIMIT 0,20";
        //echo $sql2;
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Lo sentimos, No existe visitas.";
    ...
    function get_visitas_filto($fdesde,$fhasta,$pag,$nav,$so) {
        ...
        $sql2 = "select id_pagina,nombre_pagina,url_pagina,COUNT(id_pagina) as vp ,ip_pagina,"
                . "browser_pagina,sistema_pagina,final_pagina,hora_pagina,tipo_pagina from paginas "
                . "WHERE tipo_pagina=2 and final_pagina >= '$fdesde' and final_pagina<='$fhasta' $txtfiltro1 GROUP by nombre_pagina,browser_pagina,sistema_pagina ORDER by vp  DESC ";
        //echo $sql2;
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Lo sentimos, No existe visitas.";
