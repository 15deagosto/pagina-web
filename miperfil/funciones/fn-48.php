...
class Fn48 {
    ...
    function get_visitas() {
        ...
        $sql2 = "select id_pagina,nombre_pagina,url_pagina,COUNT(id_pagina) as vp ,ip_pagina,"
                . "browser_pagina,sistema_pagina,final_pagina,hora_pagina,tipo_pagina,lugar_pagina from paginas "
                . "  GROUP by lugar_pagina ORDER by vp  DESC LIMIT 0,20";
        //echo $sql2;
        $arreglo;
    ...
    function get_visitas_limit($limit) {
        ...
        $sql2 = "select id_pagina,nombre_pagina,url_pagina,COUNT(id_pagina) as vp ,ip_pagina,"
                . "browser_pagina,sistema_pagina,final_pagina,hora_pagina,tipo_pagina,lugar_pagina from paginas "
                . " GROUP by lugar_pagina ORDER by vp  DESC LIMIT 0,$limit";
        //echo $sql2;
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Lo sentimos, No existe visitas.";
    ...
    function get_navegavisitas() {
        ...
        $sql2 = "select id_pagina,nombre_pagina,url_pagina,COUNT(id_pagina) as vp ,ip_pagina,"
                . "browser_pagina,sistema_pagina,final_pagina,hora_pagina,tipo_pagina,lugar_pagina from paginas "
                . " GROUP by browser_pagina ORDER by vp  DESC LIMIT 0,20";
        //echo $sql2;
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Lo sentimos, No existe visitas.";
    ...
    function get_sovisitas() {
        ...
        $sql2 = "select id_pagina,nombre_pagina,url_pagina,COUNT(id_pagina) as vp ,ip_pagina,"
                . "browser_pagina,sistema_pagina,final_pagina,hora_pagina,tipo_pagina,lugar_pagina from paginas "
                . " GROUP by sistema_pagina ORDER by vp  DESC LIMIT 0,20";
        //echo $sql2;
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Lo sentimos, No existe visitas.";
    ...
    function get_visitas_filto($fdesde,$fhasta,$lugar) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $txtfiltro1 = '';
        if($lugar!=''){
            $txtfiltro1 .= ' AND lugar_pagina = "'.$lugar.'" ';
        } 
        
        $sql2 = "select id_pagina,nombre_pagina,url_pagina,COUNT(id_pagina) as vp ,ip_pagina,"
                . "browser_pagina,sistema_pagina,final_pagina,hora_pagina,tipo_pagina,lugar_pagina from paginas "
                . " where final_pagina >= '$fdesde' and final_pagina<='$fhasta' $txtfiltro1 GROUP by lugar_pagina,ip_pagina ORDER by vp  DESC ";
        //echo $sql2;
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Lo sentimos, No existe visitas.";
    ...
    function get_visitas_filto1($fdesde,$fhasta,$pag,$nav,$so) {
        ...
        $sql2 = "select id_pagina,nombre_pagina,url_pagina,COUNT(id_pagina) as vp ,ip_pagina,"
                ...
                . " and final_pagina >= '$fdesde' and final_pagina<='$fhasta' $txtfiltro1 GROUP by nombre_pagina ORDER by vp  DESC ";
        //echo $sql2;
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Lo sentimos, No existe visitas.";
    ...
    function get_visitas_filto2($fdesde,$fhasta,$pag,$nav,$so) {
        ...
        $sql2 = "select id_pagina,nombre_pagina,url_pagina,COUNT(id_pagina) as vp ,ip_pagina,"
                . "browser_pagina,sistema_pagina,final_pagina,hora_pagina,tipo_pagina from paginas "
                . " and final_pagina >= '$fdesde' and final_pagina<='$fhasta' $txtfiltro1 GROUP by browser_pagina ORDER by vp  DESC ";
        //echo $sql2;
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Lo sentimos, No existe visitas.";
