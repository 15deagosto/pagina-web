<?php
class Fn_45 {
    function fn45_rsolinversion_all() {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $sql2 = "SELECT * FROM solicitud_inversion s , producto p WHERE s.id_prod = p.id_prod and p.tipo_prod = 2";
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn45_rsolinversion_all -- fn45 ";
            exit;
        } else {
            $arreglo = $resultado2;
        }
    ...
    function fn45_rsolinversion_fecha($desde, $hasta,$producto,$estado) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $txtfiltro1 ='';
        if($producto!=''){
            $txtfiltro1 = ' and s.id_prod ='.$producto.' '; 
        }if($estado!=''){
            $txtfiltro1 .= ' and s.estado_inversion ='.$estado.' '; 
        }
        $sql2 = "SELECT * FROM solicitud_inversion s , producto p  WHERE s.id_prod = p.id_prod and p.tipo_prod = 2 and s.fecha_inversion >= '$desde' and s.fecha_inversion <= '$hasta' $txtfiltro1 order by s.fecha_inversion desc ";
        //echo $sql2;
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn45_rsolinversion_fecha -- fn45 ";
            exit;
        } else {
            $arreglo = $resultado2;
        }
    ...
    function fn45_rsolinversion2_fecha($desde, $hasta,$producto,$estado) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        $txtfiltro1 ='';
        if($producto!=''){
        ...
        $sql2 = "SELECT * FROM solicitud_inversion s , producto  p  WHERE s.id_prod=p.id_prod and s.fecha_inversion >= '$desde' $txtfiltro1 and s.fecha_inversion <= '$hasta' order by s.fecha_inversion desc ";
        echo $sql2;
        $arreglo;
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn45_rsolinversion_fecha -- fn45 ";
    ...
    function fn45_usolinversion_xest($id,$estado) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
    ...
    function fn45_rsolinversion_x($id) {
        $con = new Conecciones;
        $mysqlidato = $con->crearConexion();
        ...
        $arreglo=array();
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn45_rsolinversion_x -- fn45";
            exit;
    ...
    function fn45_rzona_xid($id) {
        ...
        $arreglo=array();
        if (!$resultado2 = $mysqlidato->query($sql2)) {
            echo "Error fn45_rzona_xid -- fn45";
            exit;
        }while ($menu = $resultado2->fetch_assoc()) {
