        ...
        <ul class="navbar-nav header-right">
            ...
            <li class="nav-item dropdown notification_dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="all-notification" href="index.php">Ver todos los mensajes <i
                            class="ti-arrow-right"></i></a>
                </div>
            </li>
            <li class="nav-item dropdown header-profile">
                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                    <?php if ($tipousu_open == 0) { ?>
                        <img src="../images/<?php echo utf8_encode($fotousu_open) ?>" width="20" alt=""/>
                    <?php } else { ?>
                        <img src="../images/<?php echo utf8_encode($fotousu_open) ?>" width="20" alt=""/>
                    <?php } ?>
                    <div class="header-info">
                        <span>Hola, <strong><?php echo utf8_encode($nombreusu_open) ?></strong></span>
                        <small><?php echo utf8_encode($nombreroll_open) ?></small>
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    <a href="index.php?opc=14" class="dropdown-item ai-icon">
