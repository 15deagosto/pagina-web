...
<html lang="en">
    ...
    <body>
        ...
        <!--===== HERO AREA STARTS =======-->
        <div class="inner-pages-section-area" style="background-image: url(assets/img/banner-servicios.jpg); background-position: center; background-repeat: no-repeat; background-size: cover;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 m-auto">
                        <div class="inner-header text-center">
                            <h2 style="font-size: 65px;">Pago de servicios</h2>
                            <div class="space24"></div>
                            <a href="index.php">Inicio <i class="fa-solid fa-angle-right"></i> <span>Pago de servicios</span></a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6" data-aos="flip-right" data-aos-duration="800">
                                        <div class="single-pricing-area">
                                            <div class="pricing-box">
                                                ...
                                                <h2><img src="assets/img/icon-luz-blan.png"> <img src="assets/img/all-images/circle-white.png" alt="" class="elements19 keyframe5"></h2>
                                    ...
                                    <div class="col-lg-4 col-md-6" data-aos="flip-right" data-aos-duration="800">
                                        <div class="single-pricing-area active">
                                            <div class="pricing-box">
                                                <div class="space26"></div>
                                                <h2><img style="width: 60%;" src="assets/img/icone-de-l-eau-rouge.png"> <img src="assets/img/all-images/circle-white.png" alt="" class="elements19 keyframe5"></h2>
                                                <div class="space32"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6" data-aos="flip-right" data-aos-duration="800">
                                        <div class="single-pricing-area">
                                            <div class="pricing-box">
                                                <div class="space26"></div>
                                                <h2><img src="assets/img/icon-telef-blan.png">   <img src="assets/img/all-images/circle-white.png" alt="" class="elements19 keyframe5"></h2>
                                                <div class="space32"></div>
                                            </div>
                                        </div>
                                    </div>
...
<!--                <div class="row">
                    <div class="col-lg-12">
                        <select class="" style="width: 100%;">
                            ...
                            <option value="">BANCOS Y COOPERATIVAS</option>
                        </select>
                    </div>
                </div>-->
                <div class="row">
                        ...
                        <div class="pricing-section">
                            ...
                            <div class="pricing-table">
                                <div class="row">
                                    <span>COBRANZA</span>
                                    <span>
                                        Aaasa Corporation (Pago A Proveedores)</span>
                                    <span>$ 0.59</span>
                                </div>
                                <div class="row">
                                    <span>COBRANZA</span>
