...
$min_plazo = 1;
$max_plazo = ""; /*vencimiento poliza*/
$min_tasa = 0;
$max_tasa = 17.99;
$min_valor = 300;
$max_valor = 90;/*porcentaje*/
                            ...
                            <div data-aos="fade-left" data-aos-duration="1000" style="border-bottom: 4px solid #a31a16">
                                <div class="about-boxarea">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="space16"></div>
                                        <p style="font-size: 18px;">hasta el
                                            <span style="font-size: 25px;font-weight: 800; color: #a31a16;"> 90% </span> del capital de la poliza (DPF)</p>
                                    </div>
                                </div>
                            </div>
                            <div class="space16"></div>
                    ...
                    <div class="col-lg-6">
                        <div class="about-heading heading2">
                            ...
                            <div data-aos="fade-left" data-aos-duration="1100" style="border-bottom: 4px solid #a31a16">
                                <div class="about-boxarea">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="space16"></div>
                                        <p style="font-size: 18px;">Al <span style="font-size: 25px;font-weight: 800; color: #a31a16;">vencimiento </span>de la poliza                            </p>
                                    </div>
                                </div>
                            </div>
                            <div class="space16"></div>
                            ...
                            <div data-aos="fade-left" data-aos-duration="1100" style="border-bottom: 4px solid #a31a16">
                                <div class="about-boxarea">
                                    <div class="icons">
                                        <img src="assets/img/icon-tasa.png" style="filter: brightness(0) invert(1);max-width: 65% !important" alt="">
                                    </div>
                                    <div class="text">
                                        <a href="#" style="font-size: 24px;color:#000;">Tasa de interés</a>
                                        <div class="space16"></div>
                                        <p style="font-size: 18px;">Calculamos tu crédito <br> al
                                            <span style="font-size: 25px;font-weight: 800; color: #a31a16;"> 17.99 % </span> </p>
                                    </div>
                                </div>
                            </div>
                        </div>
