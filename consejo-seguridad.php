                ...
                <div class="row">
                    <div class="col-lg-12 m-auto">
                        <div class="inner-header text-center">
                            <h2 style="font-size: 65px; color: #fff">Consejos de seguridad</h2>
                            <div class="space24"></div>
                            <a href="index.php" style="color: #fff">Inicio <i class="fa-solid fa-angle-right" style="color: #fff"></i> <span style="color: #fff">Consejos de seguridad</span></a>
                        </div>
                    </div>
                </div>
