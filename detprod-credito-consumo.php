...
<html lang="en">
    <head>
        ...
        <title> <?php  echo $tipoCredito ?> - 15 de Agosto Cooperativa de Ahorro y Crédito</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 m-auto">
                        <div class="inner-header text-center">
                            <h2 style="font-size: 65px;"><?php echo $tipoCredito ?></h2>
                            <div class="space24"></div>
                            <a href="index.php">Inicio <i class="fa-solid fa-angle-right"></i> <span><?php echo $tipoCredito ?></span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="about-header heading5">
                            ...
                            <h2 class="text-anime-style-3"><?php echo $tipoCredito ?></h2>
                            <div class="space16"></div>
                            <p data-aos="fade-left" data-aos-duration="900"><?php echo 'Es el otorgado a personas naturales, destinado a la compra de bienes 
y servicios (vehículos de uso personal, terrenos para construcción de vivienda) no 
relacionados con una actividad productiva y/o comercial.' ?></p>
                                ...
                                <div class="about-boxarea">
                                    ...
                                    <div class="text">
                                        ...
                                        <p style="font-size: 18px;">hasta 
                                            <span style="font-size: 25px;font-weight: 800; color: #a31a16;"> 200.000,00 </span>dólares</p>
                                    </div>
                                </div>
                            </div>
                            <div class="space16"></div>
                            ...
                            <div data-aos="fade-left" data-aos-duration="1000" style="border-bottom: 4px solid #a31a16">
                                <div class="about-boxarea">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="space16"></div>
                                        <p style="font-size: 18px;">Ser mayor de 18 años y no mayor a 65 años incluido la vida del crédito. </p>
                            ...
                            <div data-aos="fade-left" data-aos-duration="1100" style="border-bottom: 4px solid #a31a16">
                                <div class="about-boxarea">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="space16"></div>
                                        <p style="font-size: 18px;">máximo hasta <span style="font-size: 25px;font-weight: 800; color: #a31a16;">48 </span>meses                            </p>
                                    </div>
                                </div>
                            </div>
                            <div class="space16"></div>
                            ...
                            <div data-aos="fade-left" data-aos-duration="1100" style="border-bottom: 4px solid #a31a16">
                                <div class="about-boxarea">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="space16"></div>
                                        <p style="font-size: 18px;">Personas Naturales bajo relación de dependencia, serivicios profesionales.                             </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-8">
                        <div class="heading3">
                            ...
                            <ul data-aos="fade-left" data-aos-duration="1000">
                                <li><img src="assets/img/icons/arrow1.svg" alt=""> Cédula</li>
                                <li><img src="assets/img/icons/arrow1.svg" alt=""> Justificativo de Ingresos</li>
                                <li> <span style="margin-left: 30px;"> - Roles de pago</span></li>
                                <li> <span style="margin-left: 30px;"> - RUC</span></li>
                                <li><img src="assets/img/icons/arrow1.svg" alt=""> Garantías</li>
                                <li> <span style="margin-left: 30px;">- Terrenos</span></li>
                                <li> <span style="margin-left: 30px;">- Casas</span></li>
                                <li> <span style="margin-left: 30px;">- Vehículos</span></li>
                                <li><img src="assets/img/icons/arrow1.svg" alt=""> Copias de los servicios básicos</li>
