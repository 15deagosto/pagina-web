...
<html lang="en">
    ...
    <body class="v2">
                ...
                <div class="row">
                    <div class="col-lg-12 m-auto">
                        <div class="inner-header text-center">
                            <h2 style="font-size: 65px;">Simulador inversión</h2>
                            <div class="space24"></div>
                            <a href="index.php">Inicio <i class="fa-solid fa-angle-right"></i> <span>Simulador inversión</span></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="about4-section-area sp1">
            <?php include './mod-simulador-inversiones.php' ?>
        </div>
        <!--===== ABOUT AREA ENDS =======-->
