...
10.501,00 a 25.000,00 dólares	3 meses	48 meses
                                ...
                                <div class="about-boxarea">
                                    ...
                                    <div class="text">
                                        ...
                                        <p style="font-size: 18px;">hasta 
                                            <span style="font-size: 25px;font-weight: 800; color: #a31a16;"> 25.000,00 </span>dólares</p>
                                    </div>
                                </div>
                            </div>
                            <div class="space16"></div>
                            ...
                            <div data-aos="fade-left" data-aos-duration="1000" style="border-bottom: 4px solid #a31a16">
                                <div class="about-boxarea">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="space16"></div>
                                        <p style="font-size: 18px;">Ser mayor de 18 años y no mayor a 65 años incluido la vida del crédito.<br><br><br><br> </p>
                            ...
                            <div data-aos="fade-left" data-aos-duration="1100" style="border-bottom: 4px solid #a31a16">
                                <div class="about-boxarea">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="space16"></div>
                                        <p style="font-size: 18px;">Destinado para socios externos e internos, en el caso de socios internos que tengan historial de dos o más operaciones crediticias en categoria Doble AA, triple AAA.                                   </p>
                                    </div>
                                </div>
                            </div>
                        </div>
