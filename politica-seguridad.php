...
$dettexto = $fnindex->fnindex_rtextosxtipo(6);
...
<html lang="en">
    <head>
        ...
        <title>Política de Seguridad - 15 de Agosto Cooperativa de Ahorro y Crédito</title>
    ...
    <body class="v2">
        ...
        <!--===== HERO AREA STARTS =======-->
        <div class="inner-pages-section-area" style="background-image: url(assets/img/banner-seguridad.jpg); background-position: center; background-repeat: no-repeat; background-size: cover;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 m-auto">
                        <div class="inner-header text-center">
                            <h2 style="font-size: 65px;color: #fff">Política de seguridad</h2>
                            <div class="space24"></div>
                            <a href="index.php" style="color: #fff">Inicio <i class="fa-solid fa-angle-right" style="color: #fff"></i> <span style="color: #fff">Política de seguridad</span></a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row body-form form title d-flex align-items-center">
                            <div class="col-lg-12 col-md-12 col-sm-12 text-sm-start text-justify wow fadeInLeft" data-wow-delay="300ms" style="text-align: justify !important; visibility: visible; animation-delay: 300ms; animation-name: fadeInLeft;">
                                ...
                                if (!empty($dettexto[0]['texto_texto'])) {
                                    ...
                                    echo '<p class="text-neutral-500">Estamos actualizando el contenido de esta sección. Si necesitas información sobre nuestra política de privacidad, contáctanos en <a href="contacto.php" class="text-rojo font-semibold">contacto.php</a>.</p>';
                                }
                                ?>
                            </div>  
                        </div>
