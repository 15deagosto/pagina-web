        ...
        <div class="col-lg-6 m-auto">
            <div class="vl-blog-1-section-box heading3 text-center space-margin60">
                ...
                <div style="display: flex;
                        ...
                        <div style="height: 47px; width: 3px; background-color: #ba0001;margin-right: 15px;"><p></p></div><h2 class="text-anime-style-3">Últimas noticias</h2><br><br>
                    </div>
        ...
        <div class="col-lg-6 col-md-12" data-aos="zoom-in-up" data-aos-duration="900">
            <div class="vl-blog-1-item">
                <div class="vl-blog-1-thumb image-anime">
                    <img src="assets/img/<?php echo utf8_encode($menunoticias['img_noticia']) ?>" alt="">
                </div>
                <div class="vl-blog-1-content">
                        ...
                        <ul>
                            <li>
                                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 20 22" fill="none">
                                    ...
                                    </svg> <?php echo utf8_encode($menunoticias['fechainicio_noticia']) ?> <span> | </span></a>
                            </li>
                            <li>
                    ...
                    <h4 class="vl-blog-1-title"><a href="detalle-noticia.php?id=<?php echo utf8_encode($menunoticias['id_noticia']) ?>"><?php echo utf8_encode($menunoticias['titulo_noticia']) ?></a></h4>
                    <div class="space16"></div>
                    <p><?php echo utf8_encode($menunoticias['resumen_noticia']) ?></p>
