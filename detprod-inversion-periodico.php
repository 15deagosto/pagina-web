...
$tipoCredito = 'INVERSIÓN AL VENCIMIENTO';
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="about-header heading5">
                            ...
                            <div class="space16"></div>
                            <p data-aos="fade-left" data-aos-duration="900"><?php echo 'Los socios o clientes de la Cooperativa podrán invertir en depósito a plazo fijo, a través de la suscripción de un contrato de DPF. Aceptando los términos y condiciones del mismo' ?></p>
